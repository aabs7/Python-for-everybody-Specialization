...
#function for looking given 'string' in dictionary
...
#---------------------------------------------------------------------------
#our required data is in format:
#<dict>
#	<dict>
#		<dict>
#so 'dict/dict/dict'
...
requiredXmlData = xmlData.findall('dict/dict/dict')
for data in requiredXmlData:
	if(lookup(data,'Track ID') is None): continue
